...
You can download all needed datasets in the following GitHub repository:
https://github.com/marcelotournier/WB_Central_Africa_1
(git clone https://github.com/marcelotournier/WB_Central_Africa_1)

To the proper working of this script, please put this file inside the folder "WB_Central_Africa_1"

The only file which is not in GitHub is the train the data for Footnote 1 (the Full World Bank dataset). 
You can Download it from: 
'http://databank.worldbank.org/data/download/WDI_csv.zip' (data in file 'WDIData.csv')
